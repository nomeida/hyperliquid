...
var PerpetualsInfoAPI = /** @class */ (function () {
    function PerpetualsInfoAPI(httpApi, exchangeToInternalNameMap, initializationPromise) {
        this.httpApi = httpApi;
        this.exchangeToInternalNameMap = exchangeToInternalNameMap;
        this.initializationPromise = initializationPromise;
    }
    PerpetualsInfoAPI.prototype.ensureInitialized = function () {
    ...
    PerpetualsInfoAPI.prototype.convertSymbol = function (symbol, mode, symbolMode) {
        if (mode === void 0) { mode = ""; }
    ...
    PerpetualsInfoAPI.prototype.convertSymbolsInObject = function (obj, symbolsFields, symbolMode) {
        var _this = this;
    ...
    PerpetualsInfoAPI.prototype.convertToNumber = function (value) {
    ...
    PerpetualsInfoAPI.prototype.getMeta = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.httpApi.makeRequest({ type: CONSTANTS.INFO_TYPES.META })];
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, raw_response ? response : this.convertSymbolsInObject(response, ["name", "coin", "symbol"], "PERP")];
                }
            });
        });
    };
    PerpetualsInfoAPI.prototype.getMetaAndAssetCtxs = function () {
        return __awaiter(this, arguments, void 0, function (raw_response) {
            var response;
            if (raw_response === void 0) { raw_response = false; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.httpApi.makeRequest({ type: CONSTANTS.INFO_TYPES.PERPS_META_AND_ASSET_CTXS })];
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, raw_response ? response : this.convertSymbolsInObject(response, ["name", "coin", "symbol"], "PERP")];
                }
    ...
    PerpetualsInfoAPI.prototype.getClearinghouseState = function (user_1) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.httpApi.makeRequest({ type: CONSTANTS.INFO_TYPES.PERPS_CLEARINGHOUSE_STATE, user: user })];
                    case 3:
                        response = _a.sent();
    ...
    PerpetualsInfoAPI.prototype.getUserFunding = function (user_1, startTime_1, endTime_1) {
    ...
    PerpetualsInfoAPI.prototype.getUserNonFundingLedgerUpdates = function (user_1, startTime_1, endTime_1) {
        return __awaiter(this, arguments, void 0, function (user, startTime, endTime, raw_response) {
            var response;
            if (raw_response === void 0) { raw_response = false; }
            return __generator(this, function (_a) {
    ...
    PerpetualsInfoAPI.prototype.getFundingHistory = function (coin_1, startTime_1, endTime_1) {
        return __awaiter(this, arguments, void 0, function (coin, startTime, endTime, raw_response) {
            var response;
            if (raw_response === void 0) { raw_response = false; }
            return __generator(this, function (_a) {
                switch (_a.label) {
