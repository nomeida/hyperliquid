...
try {
    ...
    console.log(placeOrderResponse.response.data.statuses);
    ...
    // 8. USD Transfer
    console.log("\n8. USD Transfer:");
    const usdTransferResponse = await sdk.exchange.usdTransfer('0x0C18ce20fA086ED8A1744367CeAa0605FF2A19aD', 12);
    console.log(usdTransferResponse);
    await waitForUserInput("Press Enter to continue to Spot Transfer...");

    // 9. Spot Transfer --
    console.log("\n9. Spot Transfer:");
    const spotTransferResponse = await sdk.exchange.spotTransfer('0x1F65dDE3EbEbfcb77aFD1c1059402a7227e190bB', 'PURR-SPOT', '0.001');
    ...
    console.log("\n10. Initiate Withdrawal:");
    const withdrawalResponse = await sdk.exchange.initiateWithdrawal('0x1F65dDE3EbEbfcb77aFD1c1059402a7227e190bB', 15.14);
    ...
    // 13. Vault Transfer
    console.log("\n13. Vault Transfer:");
    const vaultTransferResponse = await sdk.exchange.vaultTransfer('0x1962905b0a2d0ce7907ae1a0d17f3e4a1f63dfb7', true, 4);
